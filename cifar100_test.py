...
from models import cifar_resnet32, cifar_resnet56
import imageio
import numpy as np
...
state_dict = torch.load(r'pretrained_model/cifar-100/cifar100-resnet32-6568a0a0.pth')
...
# 这里加载了第一个data_batch
data = load_file('pretrained_model/cifar-100/test')
print(data.keys())
...
end_time = time()
imageio.imsave('delta_cifar100/ori_img' + str(i) + '.png', img)
imageio.imsave('delta_cifar100/adv_img' + str(i) + '.png', adv)

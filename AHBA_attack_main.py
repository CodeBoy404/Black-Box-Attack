...
if __name__ == "__main__":
    ...
    parser.add_argument('--model-path', '--m', default='pretrained_model/imagenet/resnet18_clean.pt', help='path to AttackModel')
    parser.add_argument('--surrogate-model-path', '--sm', default="pretrained_model/imagenet/resnext50_32x4d_ddn.pt", help='path to surrogateModel')
